...
//TODO   Instantiate private values?????
    ...
    public event Action onPlayerMaxMana;
    public void PlayerMaxMana() { if(onPlayerMaxMana != null) { onPlayerMaxMana(); } }
    public float GetPlayerMaxMana() { return player_max_mana; }
    public void SetPlayerMaxMana(float max_mana) { player_max_mana = max_mana; }
    ...
    public void PlayerManaChange() { if(onPlayerManaChange != null) { onPlayerManaChange(); } }
    public float GetManaValue() { return mana_value; }
    public void SetManaValue(float mana) { mana_value = mana; }
}
